$(document).ready(function () {
    var mode, JSON, res_DATA, h_menu_id	;
    ...
    $("#btn-submit").click(function () {
      $(".error").hide(); 
      if ($("#h_menu").val() === "" && mode == "new") {
        $(".h_menu").html("Please Enter Menu*").show();
      } else {
        insertData();
      }
    });
    ...
    function insertData() {
      ...
      var url;
      if (mode == "new") {
        url = base_Url + "insert-hmenu-list";
      } else if (mode == "edit") {
        url = base_Url + "update-hmenu-list";
        data.append("h_menu_id", h_menu_id);
      }
    ...
    $(document).on("click", ".btnEdit", function () {
      ...
      $("#h_menu").val(res_DATA[index].h_menu);
    //    console.log(res_DATA[index].h_menu_id);
      h_menu_id	 = res_DATA[index].h_menu_id;
    });
